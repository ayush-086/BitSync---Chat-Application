...
import AuthImagePattern from '../components/AuthImagePattern.jsx';
  ...
  return (
        <div className="min-h-screen grid lg:grid-cols-2 bg-cyan-950">
      {/* left side */}
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-6xl font-bold mt-2 text-white">Create Account</h1>
          ...
          <div className="text-center">
            <p className="text-base-content/60 text-white">
              ...
              <Link to="/login" className="link link-white text-2xl">
                Sign in
              </Link>
            </p>
          </div>
